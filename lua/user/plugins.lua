...
return packer.startup(function(use)
	...
	--use {"https://github.com/honza/vim-snippets.git"}
	--use {"https://github.com/marcweber/vim-addon-mw-utils.git"}
	--use {"tomtom/tlib_vim"}
	--use {"https://github.com/garbas/vim-snipmate.git"}
	...
	-- use "https://github.com/LuaLS/lua-language-server"                                          -- lu ls errors
	...
	-- Ocaml
	--use {"https://github.com/tree-sitter/tree-sitter-ocaml.git"}
